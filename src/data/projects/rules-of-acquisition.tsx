export const rulesOfAcquisitionProject = [
  `One of the major additions to Star Trek in the 1980s and 1990s was the Ferengi, a race hyper capitalist businessmen whose entire society was built on free enterprise, with the sole goal of earning profit. The precepts upon which their society is built are the Rules of Acquisition, a series of nearly three hundred proverbs designed to guide and them toward this goal.`,
  `As a personal project, to combine my love of Star Trek and programming, I created an API that will return all of the rules that have been canonically mentioned on screen in various Star Trek episodes over the last thirty years.`,
  `There are presently 50 rules in the database plus data on every episode they appeared in, including the revised benevolent rules that briefly appeared.`,
  `## API Reference
